...
export default function Page() {
    return (
        <div className="space-y-6">
            <div>
                <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Laporan Stok</h1>
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center mt-6">
                ...
                <p className="text-gray-500 max-w-md mx-auto text-sm leading-relaxed">
                    Modul <strong>Laporan Stok</strong> akan segera hadir di pembaruan berikutnya. 
